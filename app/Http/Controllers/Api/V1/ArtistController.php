...
class ArtistController extends Controller
{
    ...
    public function single(Request $request)
    {
        ...
        return CustomResponse::create([
            ...
            'best_musics' => MusicRepo::getInstance()->get()->setArtist($artist)->setSort(Music::SORT_BEST)->setWithAlbum(false)->setWithTags(true)->setToJson()->build(),
            'last_musics' => MusicRepo::getInstance()->get()->setArtist($artist)->setSort(Music::SORT_LATEST)->setWithTags(true)->setWithAlbum(false)->setToJson()->build(),
